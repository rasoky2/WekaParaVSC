...
exports.WekaAlgorithmsService = void 0;
const vscode = __importStar(require("vscode"));
class WekaAlgorithmsService {
    constructor() {
        /**
     ...
     */
    async showAlgorithmSelector(type = 'classification') {
     ...
     */
    async showAlgorithmDetails(algorithm) {
        this.log(`Mostrando detalles del algoritmo: ${algorithm.name}`);
        const panel = vscode.window.createWebviewPanel('wekaAlgorithmDetails', `WEKA - ${algorithm.name}`, vscode.ViewColumn.Two, {
            enableScripts: true
        });
     ...
     */
    _createAlgorithmDetailsHtml(algorithm) {
        return `
            <!DOCTYPE html>
            <html>
            <head>
...
exports.WekaAlgorithmsService = WekaAlgorithmsService;
//# sourceMappingURL=wekaAlgorithmsService.js.map